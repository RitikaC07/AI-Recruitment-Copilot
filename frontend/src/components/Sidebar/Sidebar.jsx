...
const menuItems = [
  ...
  { name: "Resume Upload", path: "/upload", icon: Upload },
  { name: "Candidates", path: "/candidates", icon: Users },
  { name: "Job Postings", path: "/jobs", icon: Briefcase },
  { name: "AI Matching", path: "/matching", icon: Brain },
...
function Sidebar() {
  return (
    <aside className="w-72 h-screen bg-white border-r border-gray-200 shadow-xl flex flex-col">
      {/* Logo */}
      <div className="p-8">
