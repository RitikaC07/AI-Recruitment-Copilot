...
function InterviewAssistant() {
  ...
  const evaluateCurrentInterview = async (conversationMessages = messages) => {
    if (!conversationMessages.length || evaluatingInterview) {
      return;
    }
    ...
    try {
      ...
      if (result) {
        ...
        // Refresh candidates so updated status is visible
        try {
  ...
  const startInterview = async () => {
    ...
    try {
      ...
      if (aiResponse) {
        ...
        // If AI immediately decides to end
        if (aiResponse.interview_complete) {
          setInterviewComplete(true);

          await evaluateCurrentInterview([
            firstAIMessage,
          ]);
        }
      }
  ...
  const sendAnswer = async () => {
    ...
    try {
      ...
      if (aiResponse) {
        ...
        // IMPORTANT:
        // Include the AI's final message before evaluation.
        const finalMessages = [
          ...updatedMessages,
          aiMessage,
        ];
  ...
  // =========================================================
  // RECRUITER MANUALLY ENDS INTERVIEW
  // =========================================================
  ...
  // =========================================================
  // RESET INTERVIEW WHEN JOB CHANGES
  // =========================================================
              ...
              {evaluatingInterview && (
                ...
                <div className="mt-4 bg-indigo-50 border border-indigo-200 rounded-xl p-4 text-center">
                  ...
                  <p className="text-sm text-indigo-600 mt-1">
                    The AI is analyzing the candidate's responses.
                  </p>
              ...
              {interviewComplete ? (
                ...
                <div>
                  ...
                  <button
                    ...
                    className="w-full mt-3 bg-red-600 text-white px-5 py-3 rounded-xl font-medium hover:bg-red-700 transition disabled:opacity-50 flex items-center justify-center gap-2"
                  >
